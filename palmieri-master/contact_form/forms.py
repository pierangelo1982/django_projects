...
class BasicContactForm(ContactForm):
    ...
    """
    nome = forms.CharField(label=_(u'Nome'), max_length=100, widget=forms.TextInput(attrs={'class':'form-control'}))
    cognome = forms.CharField(label=_(u'Cognome'), max_length=100, widget=forms.TextInput(attrs={'class':'form-control'}))
    email = forms.EmailField(label=_(u'email'), max_length=200, widget=forms.TextInput(attrs={'class':'form-control'}))
    body = forms.CharField(label=_(u'Messaggio'), widget=forms.Textarea(attrs={'class':'form-control'}))

    def get_email_headers(self):
        #self.fields['nome'].attrs['class'] = 'form-control input-lg'
